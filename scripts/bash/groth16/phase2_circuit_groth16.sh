compile_phase2 () {
    ...
    npx snarkjs groth16 setup "$3/$2.r1cs" ./semaphore-protocol-solidity-fixtures/ptau/pot16_final.ptau "$1/circuit_0000.zkey"
    echo "test" | npx snarkjs zkey contribute "$1/circuit_0000.zkey" "$1/circuit_0001.zkey" --name"1st Contributor name" -v
    npx snarkjs zkey verify "$3/$2.r1cs" ./semaphore-protocol-solidity-fixtures/ptau/pot16_final.ptau "$1/circuit_0001.zkey"
    ...
    npx snarkjs zkey verify "$3/$2.r1cs" ./semaphore-protocol-solidity-fixtures/ptau/pot16_final.ptau "$1/circuit_final.zkey"
...
move_verifiers_and_metadata () {
    ...
    cp $1/circuit_final.zkey semaphore-protocol-solidity-fixtures/fixtures/$bridgeType/$size/circuit_final.zkey
